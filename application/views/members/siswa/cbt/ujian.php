            ...
            <div class="row mb-2">
                <div class="col-6">
                    <div class="info-box bg-transparent shadow-none">
                        <!-- <img src="<?= base_url() ?>/assets/img/satria_circle.png" width="60" height="60"> -->
                        <img class="d-flex mr-3 rounded-circle img-thumbnail thumb-lg" onerror="this.src='<?= base_url('assets/img/siswa.png') ?>'" src="<?= base_url($siswa->foto) ?>" width="90" height="90">
                        <div class="info-box-content">
                            <span class="text-white" style="line-height: 1; display: inline-block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;"><b><?= $siswa->nama ?></b></span> <br>
                            <span class="text-white" style="line-height: 1; display: inline-block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;"><?= $siswa->nis ?></span>
                            <span class="text-white" style="display: inline-block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;"><?= $siswa->nama_kelas ?></span>
                        </div>
                    </div>
                </div>
                <!--<div class="col-6">
                    <div class="float-right mt-2 d-none d-md-inline-block">
                        ...
                        <div class="float-right" style="line-height: 1.2">
                            <span class="text-white" style="font-size: 24pt; line-height: 0.7;"><b>satriaCBT</b></span>
                            ...
                            <div style="border: 1px solid; border-color: #D3D3D3;">
                                <div class="konten-soal-jawab">
                                    <div class="row p-2 mb-4 ml-1">
                                        <div id="konten-soal" class="table-responsive soal-content"></div>
                                    </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1 text-center">
                                    <button class="btn btn-primary btn-oval-sm" id="prev" onclick="prevSoal()">
                                        ...
                                        <span class="d-none d-md-inline-block"><b>Soal Sebelumnya</b></span>
                                    </button>
                                </div>
                                <div class="flex-grow-1 text-center">
