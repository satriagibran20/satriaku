                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="alert alert-default-danger">
                                        ...
                                        <ul>
                                            <li>
                                                Meninggalkan ruang ujian tanpa izin pengawas/proktor ujian 
                                            </li>
                                            <li>
                                                Logout/Keluar dari aplikasi tanpa izin dari pengawas/ proktor ujian
                                            </li>
                                            <li>
                                                Saling memberi, menerima jawaban sesama peserta ujian
                                            </li>
                                            <li>
                                                Membawa device lebih dari satu kedalam ruang ujian, mengganti device melapor
                                            </li>
                                            <li>
                                                Membawa makanan kedalam ruang ujian dan minuman.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
