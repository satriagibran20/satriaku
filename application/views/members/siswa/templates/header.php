...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand-md navbar-dark navbar-navy border-bottom-0">
        <ul class="navbar-nav ml-2 <?= $dnone ?>">
            <li class="nav-item">
                <a href="<?= base_url('dashboard') ?>" type="button" class="btn btn-primary">
                    <i class="fas fa-angle-double-left mr-2"></i><span class="d-none d-sm-inline-block ml-1">Beranda</span>
                </a>
            </li>
        </ul>
        <div class="mx-auto text-white text-center" style="line-height: 1.0">
            <span class="text-lg p-0"><?= $setting->nama_aplikasi ?></span>
            <br>
            <marquee width="100%" scrolldelay="300" onmouseover="this.stop()" onmouseout="this.start()"> <small>Tahun: <?= $tp_active->tahun ?> Semester: <?= $smt_active->smt ?></small> </marquee>
            <!-- <strong><b><small>Tahun Pelajaran: <?= $tp_active->tahun ?> Smt:<?= $smt_active->smt ?></small> </b></strong> -->
        </div>
